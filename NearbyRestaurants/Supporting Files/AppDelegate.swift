...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -> Bool
    {
        ...
        {
            if let placeID = url.host
            {
                let storyboard = UIStoryboard(name: "Main", bundle: nil)
                
                let detailController : NearbyRestaurantDetailViewController = storyboard.instantiateViewController(withIdentifier: "NearbyRestaurantDetailViewController") as! NearbyRestaurantDetailViewController
